"""RoboTwin entry point for place_bread_basket_left_oppo_cam.
...
from ..impl.place_bread_basket_left_impl import PlaceBreadBasketLeftImpl


class place_bread_basket_left_oppo_cam(PlaceBreadBasketLeftImpl):
