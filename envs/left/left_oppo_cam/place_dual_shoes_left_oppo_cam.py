"""RoboTwin entry point for place_dual_shoes_left_oppo_cam.
...
from ..impl.place_dual_shoes_left_impl import PlaceDualShoesLeftImpl


class place_dual_shoes_left_oppo_cam(PlaceDualShoesLeftImpl):
