...
Left workspace manifest: place_bread_basket, version 3 (2026-08-14)
Actors and clearance: breadbasket (static, union sweep x in [-0.44,-0.12], y
    in [-0.28,0.04] covering the whole family appearance envelope so the
    basket overlaps the bread pickup band, footprint-aware clearance min 0.13
    m), bread0/bread1 (dynamic, shared pickup band x in [-0.44,-0.34], y in
    [-0.18,0.04], yaw up to 0.50, pairwise clearance min 0.10 m).  The 0.13 m
    basket clearance keeps any bread centre outside the 076_breadbasket hull.
...
Pilot evidence: central-cam 30-seed pilot on version 0 0.67 (20/30 success),
    ...
    version 3 (union basket sweep) 50-seed pilot 0.52 (26/50 success), manifest
    hash 6d79f86cb766c76c
"""
