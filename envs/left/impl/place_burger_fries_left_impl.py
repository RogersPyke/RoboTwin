...
Left workspace manifest: place_burger_fries, version 3 (2026-08-14)
Actors and clearance: tray (static, x in [-0.44,-0.08], y in [-0.16,-0.04],
    scale 2.0, min 0.08 m), hamburg and frenchfries (dynamic, both sharing one
    identical pickup band x in [-0.46,-0.34], y in [-0.35,-0.27], yaw up to
    0.20, pairwise min 0.08 m).  Version 2 split the foods into upper and lower
    y bands; a probe showed each food alone is graspable in either band, but
    both foods in the upper band occlude the left arm's approach to the first
...
Pilot evidence: central-cam 30-seed pilot on version 0 0.60 (18/30 success),
    ...
    version 3 (both foods share the lower band) 50-seed pilot 0.56 (28/50
    success), manifest hash 176bcde62f9cb29c
"""
