...
Actors and clearance: block1/2/3 (dynamic boxes, half sizes
    ...
    line in the xoy plane whose angle with the x axis stays within +-45 deg,
...
# uniform in +-45 deg (so large < medium < small in x always holds), each
...
# fitting inside the envelope diagonally even at the 45 deg extreme.
