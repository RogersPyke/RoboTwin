...
Purpose:
- Subclass HuggingFace TrainerCallback and compose early_stop_util.early_stop.RelativeEarlyStopTracker
...
- early_stop_util.early_stop.RelativeEarlyStopTracker (RoboTwin policy root on sys.path)
