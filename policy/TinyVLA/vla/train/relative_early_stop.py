...
Purpose:
- Subclass HuggingFace TrainerCallback and compose rw_common.early_stop.RelativeEarlyStopTracker
...
- rw_common.early_stop.RelativeEarlyStopTracker (RoboTwin policy root on sys.path)
