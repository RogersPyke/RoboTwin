...
from early_stop_util.flow_eval_best_symlinks import prepare_tinyvla_flow_best_symlinks
...
def main() -> int:
    ...
    try:
        prepare_tinyvla_flow_best_symlinks(BASE_DIR, BASE_DIR.parent.parent, EVAL_STEMS, FLOW_SEED)
